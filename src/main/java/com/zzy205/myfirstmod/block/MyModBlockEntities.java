...
public final class MyModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TrailingWheelBlockEntity>> trailing_wheel_entity = BLOCK_ENTITY_TYPES.register("trailing_wheel", () -> BlockEntityType.Builder.of(TrailingWheelBlockEntity::new, MyModBlocks.trailing_wheel.get()).build(null));
