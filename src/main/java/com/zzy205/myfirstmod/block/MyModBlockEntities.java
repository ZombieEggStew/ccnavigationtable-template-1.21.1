...
public final class MyModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<MyAeroSensorBlockEntity>> my_aero_sensor_entity = BLOCK_ENTITY_TYPES.register("my_aero_sensor", () -> BlockEntityType.Builder.of(MyAeroSensorBlockEntity::new, MyModBlocks.my_aero_sensor.get()).build(null));
