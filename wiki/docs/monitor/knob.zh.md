...
1.0 7 返回相对比例（数字，0..100）：归一化角度 / 设定的最大旋转角度。

1.0.8 返回相对比例（数字，0..1）：归一化角度 / 设定的最大旋转角度。
...
1.0.7 返回绝对比例（数字，0..100）：绝对角度 * 100/ 设定的最大旋转角度。未开启物理限位时旋钮可转出设定范围，返回值可能超过 100 或为负数。

1.0.8 返回绝对比例（数字）：绝对角度 / 设定的最大旋转角度。未开启物理限位时旋钮可转出设定范围，返回值可能超过 1 或为负数。
